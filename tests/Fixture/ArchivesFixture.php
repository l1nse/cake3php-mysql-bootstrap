...
class ArchivesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'url' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'Index_archive' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2017-05-16 18:33:15',
            'modified' => '2017-05-16 18:33:15'
        ],
    ];
}
