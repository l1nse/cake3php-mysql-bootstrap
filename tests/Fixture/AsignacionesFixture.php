...
class AsignacionesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Index_asignaciones' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
            'FK_Reference_7' => ['type' => 'index', 'columns' => ['tipo_producto_id'], 'length' => []],
            'FK_Reference_8' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'tipo_producto_id' => 1,
            'created' => '2017-05-08 19:02:08',
            'modified' => '2017-05-08 19:02:08',
            'active' => 1
        ],
    ];
}
