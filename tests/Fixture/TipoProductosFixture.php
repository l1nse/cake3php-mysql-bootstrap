...
/**
 * TipoProductosFixture
 *
 */
class TipoProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Index_tipo_producto' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-05-08 19:03:59',
            'modified' => '2017-05-08 19:03:59',
            'active' => 1
        ],
    ];
}
