...
class CalendariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipo_calendario' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'observacion' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        '_indexes' => [
            'Index_reuniones' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'date_time' => '2017-09-07 11:33:26',
            'address' => 'Lorem ipsum dolor sit amet',
            'active' => 1,
            'created' => '2017-09-07 11:33:26',
            'modified' => '2017-09-07 11:33:26',
            'tipo_calendario' => 1,
