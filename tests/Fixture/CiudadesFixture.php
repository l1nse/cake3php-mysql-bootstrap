...
class CiudadesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Index_ciudades' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
            'FK_Reference_45' => ['type' => 'index', 'columns' => ['regione_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-06-05 15:54:43',
            'modified' => '2017-06-05 15:54:43'
        ],
    ];
}
