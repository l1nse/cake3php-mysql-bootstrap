...
/**
 * SubtiposProductosFixture
 *
 */
class SubtiposProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Index_subtipo_producto' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
            'FK_Reference_4' => ['type' => 'index', 'columns' => ['tipo_producto_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-05-08 18:52:23',
            'modified' => '2017-05-08 18:52:23',
            'active' => 1
        ],
    ];
}
