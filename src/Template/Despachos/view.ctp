...
<div class="despachos view large-9 medium-8 columns content">
    <h3>Ticket N° <?= h($despacho->ticket->id) ?>&nbsp;<a class="btn btn-primary btn-xs" href="<?php echo APP_URI; ?>tickets/view2/<?php echo $despacho->ticket->id; ?>" data-toggle="tooltip" data-placement="top" title="Ver"><i class="glyphicon glyphicon-search"></i> Ver Ticket</a></h3>
