...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Isapre'), ['action' => 'edit', $isapre->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Isapre'), ['action' => 'delete', $isapre->id], ['confirm' => __('Are you sure you want to delete # {0}?', $isapre->id)]) ?> </li>
...
<div class="isapres view large-9 medium-8 columns content">
    <h3><?= h($isapre->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($isapre->ficha_personales)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($isapre->ficha_personales as $fichaPersonales): ?>
            <tr>
