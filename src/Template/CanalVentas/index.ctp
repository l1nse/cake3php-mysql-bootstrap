...
<div class="canalVentas index large-9 medium-8 columns content">
    <h3><?= __('Canal Ventas') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($canalVentas as $canalVenta): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $canalVenta->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $canalVenta->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $canalVenta->id], ['confirm' => __('Are you sure you want to delete # {0}?', $canalVenta->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
