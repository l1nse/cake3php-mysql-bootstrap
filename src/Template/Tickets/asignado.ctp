            ...
            <tr class="<?php echo $td_class; ?>">
                ...
                <td class="actions">
                    ...
                    <?php
                        ...
                        if($ticket->active=='0' || $ticket->active=='3' || $ticket->active=='6'){
                        ?>
                            <a class="btn btn-success btn-xs" href="#" data-toggle="tooltip" data-placement="left" title="Gestión" disabled="disabled"><i class="glyphicon glyphicon-open-file"></i></a>
                            
                        <?php
                        }else{
                        ?>
                            <a class="btn btn-success btn-xs" href="<?php echo APP_URI; ?>tickets/gestion/<?php echo $ticket->id; ?>" data-toggle="tooltip" data-placement="left" title="Gestión"><i class="glyphicon glyphicon-open-file"></i></a>
