...
<div class="tickets form large-9 medium-8 columns content">
    ...
    <?php
    if($ticket->active!='6' && $ticket->active!='0'){
    ?>
    ...
    <div class="row">
        ...
        <?php
            if($ticket->active!='6' && $ticket->active!='0' && $ticket->active!='5'){

        ?>
            <?= $this->Form->button('Anular',  array("class" => 'btn btn-info', 'id' => 'btn_anular')) ?>
            <?= $this->Form->button('Rechazar',  array("class" => 'btn btn-danger', 'id' => 'btn_rechazar')) ?>
            <?= $this->Form->button('Aprobar',  array("class" => 'btn btn-success', 'id' => 'btn_aprobar')) ?>
