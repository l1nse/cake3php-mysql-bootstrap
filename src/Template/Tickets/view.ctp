    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                ?>
                    <a class="btn btn-primary btn-xs" href="<?php echo APP_URI; ?>despachos/view2/<?php echo $ticket->despachos[0]->id; ?>" data-toggle="tooltip" data-placement="left" title="Ver Despacho"><i class="glyphicon glyphicon-search"></i> Ver Despacho</a>
                <?php
                }
                ?>
            </td>
