...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tipo Movimiento'), ['action' => 'edit', $tipoMovimiento->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tipo Movimiento'), ['action' => 'delete', $tipoMovimiento->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tipoMovimiento->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Tipo Movimientos'), ['action' => 'index']) ?> </li>
...
<div class="tipoMovimientos view large-9 medium-8 columns content">
    <h3><?= h($tipoMovimiento->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($tipoMovimiento->ficha_personales)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($tipoMovimiento->ficha_personales as $fichaPersonales): ?>
            <tr>
