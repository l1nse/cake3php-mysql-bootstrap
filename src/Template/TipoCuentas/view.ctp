...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tipo Cuenta'), ['action' => 'edit', $tipoCuenta->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tipo Cuenta'), ['action' => 'delete', $tipoCuenta->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tipoCuenta->id)]) ?> </li>
...
<div class="tipoCuentas view large-9 medium-8 columns content">
    <h3><?= h($tipoCuenta->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($tipoCuenta->ficha_personales)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($tipoCuenta->ficha_personales as $fichaPersonales): ?>
            <tr>
