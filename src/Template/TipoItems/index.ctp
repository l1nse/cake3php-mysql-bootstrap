...
<div class="tipoItems index large-9 medium-8 columns content">
    <h3><?= __('Tipo Items') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $tipoItem->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $tipoItem->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $tipoItem->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tipoItem->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
