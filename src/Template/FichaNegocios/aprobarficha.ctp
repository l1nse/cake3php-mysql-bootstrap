...
<!-- Modal para  aceptar enviar a control ficha-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" >
        ...
        <div class="row" style="text-align: center;">
                <?php echo "<h3>Esta seguro que decea enviar a control la ficha nº".$fichaNegocios[0]['id']."<h3>" ?> 
            <textarea class="form-control col-xs-12" id="observacionaprobar" name="observacionrechazo" rows="4"></textarea>        
        </div>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal" >Cerrar</button>
            <button type="button" class="btn btn-primary" id="btn_aprobar" name="btn_aprobar">Aceptar</button>
        </div>
