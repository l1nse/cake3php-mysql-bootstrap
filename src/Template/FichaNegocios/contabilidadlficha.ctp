            ...
            <tr>
                ...
                <td style="text-align: left;"><?= $estado;  ?></td>
                 <td>
                    ...
                    <!--<a class="btn btn-warning btn-xs" href="#" data-toggle="tooltip" data-placement ="left" disabled="true" block="true" title="Editar"><i class="glyphicon glyphicon-edit"></i></a> -->
                
                    <a class="btn btn-primary btn-xs" href="#" data-toggle="tooltip" data-placement="left"  title="Ver utilidad"><i class="glyphicon glyphicon-search" ></i></a>

                    <a class="btn btn-success btn-xs" href="javascript:aprobarContabilidad(<?php echo $row->id; ?> )" data-toggle="tooltip" data-placement="left" title="Enviar a facturación"><i class="glyphicon glyphicon-check" ></i></a>

                    <a class="btn btn-danger btn-xs" href="javascript:rechazarFicha(<?php echo $row->id; ?> )" data-toggle="tooltip" data-placement="left" title="Rechazar"><i class="glyphicon glyphicon-trash" ></i></a>
                </td>
...
<!-- Modal para  aceptar enviar a facturacion -->
<div class="modal fade" id="modalContabilidadFicha"  role="dialog" aria-labelledby="myModalLabel" >    
  <div class="modal-dialog" role="document" ">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body" >
        ...
        <div class="row" style="text-align: center;">
                <?php echo "<h3>Esta seguro que decea enviar a facturacion la ficha nº".$fichaNegocios[0]['id']."<h3>" ?> 
        </div>

        <textarea class="form-control col-xs-12" id="observacioncontabilidad" name="observacionrechazo" rows="4"></textarea>
           <br>
        

        <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal" >Cerrar</button>
            <button type="button" class="btn btn-primary" id="btn_contabilidad" name="btn_contabilidad">Aceptar</button>
        </div>
